...
If address is not found, then the central point will be ['красная площадь']''')
    ...
    def getData(self, brand_name):
        ...
        while i < 10:
            try:
                ...
                restaurants.append(self.Restaurant(name, address, coordinates))
                i += 1
            except IndexError:
                break
            except KeyError:
    ...
    def constructMapURL(self, restaurants):
        s = ''
        ...
        return 'https://static-maps.yandex.ru/1.x/?l=map&z=14&ll={}&pt={}'.format(self.CENTRAL_POINT, s)
